                	...
                	%>
                	 ...
                	 <li class="dropdown">
	                    ...
	                    <ul class="dropdown-menu">
	                        ...
	                        <li><a href="customer/changeinfo.jsp">Thay đổi thông tin</a></li>
	                        <li><a href="customer/changepass.jsp">Đổi mật khẩu</a></li>
	                        <li><hr class="dropdown-divider"></li>
		                    <li><a href="khachhang?action=logout">Đăng xuất</a></li>
