        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="myNavbar">
                ...
                <ul class="nav navbar-nav navbar-right">
                	...
                	%>
                	 ...
                	 <li class="dropdown">
	                    ...
	                    <ul class="dropdown-menu">
	                        ...
	                        <li><a href="<%=url %>/customer/changeavatar.jsp">Đổi ảnh đại diện</a></li>
	                        <li><a href="<%=url %>/customer/changeinfo.jsp">Thay đổi thông tin</a></li>
	                        <li><a href="<%=url %>/customer/changepass.jsp">Đổi mật khẩu</a></li>
                	...
                	{
                	%>
                		<li><a href="customer/login.jsp"><span class="glyphicon glyphicon-log-in"></span> Login</a></li>
                	<%
                	}
                	%>	
