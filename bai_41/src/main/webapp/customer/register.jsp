...
<body>
	<%
		...
		String email = request.getAttribute("val_email")+"";
            ...
            <form action="<%=url %>/khachhang" method="post">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <div class="mb-3">
                            <label for="sodienthoai" class="form-label">Email <span
                                    class="require">*</span></label>
                            <input type="email" class="form-control" name="email" value="<%=email.equals("null")?"":email%>" required>
                        </div>
