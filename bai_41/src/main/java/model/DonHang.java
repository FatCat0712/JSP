...
public class DonHang {
	...
	public String toString() {
		return "DonHang [maDonHang=" + maDonHang + ", khachHang=" + khachHang.getMaKhachHang() + ", diaChiNguoiMua=" + diaChiNguoiMua
				+ ", diaChiNhanHang=" + diaChiNhanHang + ", trangThai=" + trangThai + ", hinhThucThanhToan="
				+ hinhThucThanhToan + ", trangThaiThanhToan=" + trangThaiThanhToan + ", tienDaThanhToan="
				+ tienDaThanhToan + ", tienConThieu=" + tienConThieu + ", ngayDatHang=" + ngayDatHang
